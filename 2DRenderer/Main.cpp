...
int main(int, char**)
{
	...
	while (!quit)
	{
		...
		/*for (int i = 0; i < 1; i++)
		{
			framebuffer->DrawTriangle(renderer->width >> 1, renderer->height >> 1, rand() % renderer->width, rand() % renderer->height, rand() % renderer->width, rand() % renderer->height, { 255, 0, 255, 255 });
		}*/
		/*for (int i = 0; i < 1; i++)
		{
			framebuffer->DrawCircle(renderer->width >> 1, renderer->height >> 1, 250, { 255, 0, 255, 255 });
		}*/
		/*for (int i = 0; i < 20; i++)
		{
