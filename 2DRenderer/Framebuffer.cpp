...
void Framebuffer::DrawCubicCurve(int x1, int y1, int x2, int y2, int x3, int y3, int x4, int y4, int steps, const color_t& color)
{
    ...
    for (int i = 0; i < steps; i++)
    {
        ...
        float b1 = 3.0f * pow((1 - t1), 2) * t1;
        float c1 = 3.0f * pow((1 - t1), 2) * t1;
        float d1 = (float)pow(t1, 3);

        int sx1 = a1 * x1 + b1 * x2 + c1 * x3 + d1 * x4;
        int sy1 = a1 * y1 + b1 * y2 + c1 * y3 + d1 * y4;

        float t2 = (i + 1) * dt;

        float a2 = (float)pow((1 - t2), 3);
        float b2 = 3.0f * pow((1 - t2), 2) * t2;
        float c2 = 3.0f * pow((1 - t2), 2) * t2;
        float d2 = (float)pow(t2, 3);

        int sx2 = a2 * x1 + b2 * x2 + c2 * x3 + d2 * x4;
        int sy2 = a2 * y1 + b2 * y2 + c2 * y3 + d2 * y4;
